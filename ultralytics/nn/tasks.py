from .modules.block import GhostModule, SEBlock, CBAMBlock, DWBlock
globals()['GhostModule'] = GhostModule
globals()['SEBlock'] = SEBlock
globals()['CBAMBlock'] = CBAMBlock
globals()['DWBlock'] = DWBlock
...
def parse_model(d, ch, verbose=True):
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            if m is C2fCIB:
                legacy = False
        elif m in (SEBlock, CBAMBlock, DWBlock):
            c1, c2 = ch[f], ch[f]
            args = [c1, *args]
        elif m is AIFI:
            args = [ch[f], *args]
